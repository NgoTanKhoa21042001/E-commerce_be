...
// Create Order
exports.createOrder = catchAsynErrors(async (req, res, next) => {
  const {
    shippingInfo,
    orderItems,
    paymentInfo,
...
// get single orders
exports.getSingleOrders = catchAsynErrors(async (req, res, next) => {
...
exports.getAdminAllOrders = catchAsynErrors(async (req, res) => {
...
exports.updateAdminOrder = catchAsynErrors(async (req, res, next) => {
